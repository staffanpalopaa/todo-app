...
import { Todo, UpdateTodoRequest, updateTodoRequestSchema } from "@/schema/todo";
...
export const UpdateTodoDialog: React.FC<UpdateTodoDialogProps> = ({
  isOpen,
  onClose,
  todo,
}) => {
      ...
      <DialogContent className="sm:max-w-[425px] md:max-w-[600px] p-6 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">
            <Pencil className="w-6 h-6 text-blue-600" /> Edit Todo
          </DialogTitle>
