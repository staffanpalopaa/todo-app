...
{"id":"d44079b6-f2ee-442d-bfd5-d60b32f6f046","description":"Delete Task","cardinality":"one-to-many","dataFields":[{"name":"Task ID","type":null},{"name":"Confirm Deletion","type":null},{"name":"Reason for Deletion","type":null},{"name":"Archived Status","type":null}],"gwtDescriptions":["Given a task exists for the user, when the user issues a 'Delete Task' command for that task, then a 'Task Deleted' event is emitted and the task is no longer visible in the user's task list."]}
