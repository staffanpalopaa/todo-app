...
{"id":"a5bf8ebe-ba2a-4dd5-a9bf-117689a56b88","description":"Create Task","cardinality":"one-to-many","dataFields":[{"name":"Task Title","type":null},{"name":"Task Description","type":null},{"name":"Due Date","type":null},{"name":"Priority Level","type":null},{"name":"Category Tags","type":null}],"gwtDescriptions":["Given the user wants to organize their work, when the user issues a 'Create Task' command with a title and description, then a 'Task Created' event is emitted and the task appears in their task list."]}
