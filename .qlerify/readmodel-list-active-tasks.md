...
{"id":"943d82ec-57a9-4444-9903-2835ff97cef9","description":"List Active Tasks","cardinality":"one-to-many","dataFields":[{"name":"Task Title","type":null},{"name":"Task Description","type":null},{"name":"Current Status","type":null},{"name":"Due Date","type":null},{"name":"Priority Level","type":null},{"name":"Time Estimate","type":null}],"gwtDescriptions":["Given an active task exists for the user, when the user issues a 'Complete Task' command for that task, then a 'Task Completed' event is emitted and the task's status is updated to completed."]}
